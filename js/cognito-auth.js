...
(function scopeWrapper($) {
    ...
    function calculateSecretHash(username) {
        var clientSecret = 'jtqbbugfjimopm04i2ldm9hs045npbj3o8lr7bppn15588gm66h';
        var clientId = '17orluq0pjsa17tofo16ebs20t';
        
        // Message is username + clientId
        var message = username + clientId;
        
        // Create HMAC SHA256 hash
        var hmac = CryptoJS.HmacSHA256(message, clientSecret);
